 ...
 */
package com.github.swiperemoveitem.swipe;
...
import com.github.swiperemoveitem.R;
...
public class SwipeMenuLayout extends FrameLayout implements SwipeSwitch {
    ...
    private OnSwipeMenuItemClickListener mSwipeRemoveItemListener;
    ...
    private void smoothToDeleteMenu(int duration) {
        if (mSwipeCurrentHorizontal != null) {
            ...
            new Handler().postDelayed(new Runnable() {
                public void run() {
                    if (mSwipeRemoveItemListener != null) {
                        mSwipeRemoveItemListener.onItemClick(SwipeMenuLayout.this,
                                ((SwipeMenuView) mSwipeCurrentHorizontal.getMenuView())
                                        .getAdaterViewHolder().getAdapterPosition(),
                                0, SwipeMenuRecyclerView.RIGHT_DIRECTION);
                    }
                    isDelete = false;
                }
            }, duration);
    ...
    public void closeMenu() {
        mScroller.startScroll(-Math.abs(scrollX), 0, Math.abs(scrollX), 0, 0);
    }
...
//            int menuViewHeight = contentViewHeight == 0 ? leftMenu.getMeasuredHeightAndState() : contentViewHeight;
    ...
    public void setSwipeMenuItemRemoveListener(OnSwipeMenuItemClickListener mSwipeMenuItemClickListener) {
        this.mSwipeRemoveItemListener = mSwipeMenuItemClickListener;
    }
}
